...
exports.discordStrategy = new DiscordStrategy(discordStrategySettings, handleDiscordLogin);
function handleDiscordLogin(req, discordAccessToken, refreshToken, discordProfile, callback) {
