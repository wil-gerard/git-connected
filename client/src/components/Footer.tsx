            ...
            <div className="container mx-auto px-6">
                <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 lg:px-52 flex flex-col md:flex-row justify-between">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="my-2"><a href="/" className="text-gray-300 text-md hover:text-primary-500 transition duration-300">Discord</a></span>
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="my-2"><a href="/" className="text-gray-300 text-md hover:text-primary-500 transition duration-300">Project Repo</a></span>
                        <span className="my-2"><a href="/" className="text-gray-300 text-md hover:text-primary-500 transition duration-300">Lead Developer</a></span>
                    </div>
                </div>
            </div>
            <div className="container mx-auto px-6">
